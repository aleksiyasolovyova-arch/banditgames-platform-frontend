//original code is from reactbits, with refactoring so it fits wtith new react best practices
...
export const PixelBlast = memo(({
    ...
    const prevConfigRef = useRef<Partial<PixelBlastProps>>(null)
