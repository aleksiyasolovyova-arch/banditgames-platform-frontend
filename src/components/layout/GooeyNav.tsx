    ...
    return (
        ...
        `}
            ...
            <div className="relative inline-block" ref={containerRef}>
                <nav className="flex relative z-[3]" style={{ transform: 'translate3d(0,0,0.01px)' }}>
                    <ul
                        ref={navRef}
                        className="flex gap-8 list-none p-2 px-6 m-0 relative z-[3] bg-black/40 backdrop-blur-md rounded-full border border-white/10"
                        style={{
                            color: 'white',
